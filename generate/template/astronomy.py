...
class _iau2000b:
    def __init__(self, time):
        ...
        arg = math.fmod((2.0*f) + (-2.0*d) + (1.0*om), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((1.0*elp) + (1.0*om), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        dp += (-14053.0 + -25.0*t)*sarg + 79.0*carg
        de += (8551.0 + -2.0*t)*carg + -45.0*sarg
        arg = math.fmod((-1.0*el) + (2.0*d) + (1.0*om), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((-1.0*el) + (2.0*f) + (2.0*d) + (1.0*om), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((1.0*elp) + (2.0*f) + (2.0*om), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((2.0*d) + (1.0*om), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((-2.0*el) + (2.0*d) + (1.0*om), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((-1.0*elp) + (2.0*f) + (-2.0*d) + (1.0*om), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((-1.0*el) + (-1.0*elp) + (2.0*d), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((1.0*el) + (-1.0*elp), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((-1.0*el) + (2.0*f), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((-2.0*el) + (1.0*om), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
        ...
        arg = math.fmod((-1.0*el) + (1.0*elp) + (1.0*d), _PI2)
        sarg = math.sin(arg)
        carg = math.cos(arg)
